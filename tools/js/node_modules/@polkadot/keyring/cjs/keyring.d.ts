...
export declare class Keyring implements KeyringInstance {
    ...
    */
    addFromUri(suri: string, meta?: KeyringPair$Meta, type?: KeypairType, wordlist?: string[], rounds?: number): KeyringPair;
    /**
     * @name createFromJson
     ...
     * @param rounds - Optional: Number of PBKDF2 iterations to run (default: 210000 (when onlyJS = true) or 2048 (when onlyJS = false).
     */
    createFromUri(_suri: string, meta?: KeyringPair$Meta, type?: KeypairType, wordlist?: string[], rounds?: number): KeyringPair;
    /**
     * @name encodeAddress
